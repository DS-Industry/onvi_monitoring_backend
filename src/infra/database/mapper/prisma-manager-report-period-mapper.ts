...
export class PrismaManagerReportPeriodMapper {
  static toDomain(entity: PrismaManagerReportPeriod): ManagerReportPeriod {
    ...
    return new ManagerReportPeriod({
      ...
      sumStartPeriod: entity.sumStartPeriod / 100,
      sumEndPeriod: entity.sumEndPeriod / 100,
  ...
  static toPrisma(
    ...
    return {
      ...
      sumStartPeriod: managerReportPeriod.sumStartPeriod * 100,
      sumEndPeriod: managerReportPeriod.sumEndPeriod * 100,
