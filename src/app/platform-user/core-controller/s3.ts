...
import { GetPresignedUrlDto, PutPresignedUrlDto } from './dto/receive/presigned-url.dto';
...
export class S3Controller {
  ...
  async getPresignedUrl(@Query() query: GetPresignedUrlDto): Promise<PresignedUrlResponseDto> {
  ...
  @Post('presigned-url')
  @HttpCode(HttpStatus.OK)
  async putPresignedUrl(@Body() body: PutPresignedUrlDto): Promise<PresignedUrlResponseDto> {
